...
level_2.add_enemy(0, 650, 300, 600, 750, 3)
level_2.add_enemy(0, 880, 130, 280, 1000, 0)
level_2.add_enemy(0, 1820, 0, 1600, 1950, 1)

level_2.add_platform(300, 170, 300, 250, 5, 0, -3)
level_2.add_platform(300, 565, 300, 250, 7, 0, 0)

level_2.add_platform(550, 550, 300, 100, 15, 0, 0)
level_2.add_platform(700, 100, 300, 250, 5, 2, 0)
level_2.add_platform(900, 250, 300, 250, 5, 0, -3)
level_2.add_platform(1100, 550, 300, 100, 15, 0, 0)


level_2.set_goal(1300, 380)
